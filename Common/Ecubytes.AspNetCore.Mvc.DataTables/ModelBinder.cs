...
using Ecubytes.AspNetCore.Mvc.DataTables.NameConvention;
    ...
    public class ModelBinder : IModelBinder
    {
        ...
        public Task BindModelAsync(ModelBindingContext bindingContext)
        {
            return Task.Factory.StartNew(() =>
            {
                BindModel(
                    bindingContext,
                    Ecubytes.AspNetCore.Mvc.DataTables.Configuration.Options,
        ...
        private static IEnumerable<IColumn> ParseColumns(IValueProvider values, IRequestNameConvention names)
        {
            ...
            while (true)
            {
                ...
                Parse<string>(columnField, out _columnField);
