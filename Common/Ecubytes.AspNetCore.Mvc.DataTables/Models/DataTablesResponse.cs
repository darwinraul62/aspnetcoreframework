...
namespace Ecubytes.AspNetCore.Mvc.DataTables
{
    ...
    public class DataTablesResponse : IDataTablesResponse
    {
        ...
        public override string ToString()
        {
            ...
            {                 
                if (IsSuccessResponse())
                {
                    ...
                    if (Ecubytes.AspNetCore.Mvc.DataTables.Configuration.Options.IsResponseAdditionalParametersEnabled && AdditionalParameters != null)
                    {
        ...
        public static DataTablesResponse Create(IDataTablesRequest request, int totalRecords, int totalRecordsFiltered, object data, IDictionary<string, object> additionalParameters)
        {
            ...
            if (Ecubytes.AspNetCore.Mvc.DataTables.Configuration.Options.IsDrawValidationEnabled)
            {
