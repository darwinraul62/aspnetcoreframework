...
{
    /// <summary>
    /// Handles DataTables registration and holds default (global) configuration options.
    /// </summary>
    public static class Configuration
    {
        ...
        {
            Options = new Ecubytes.AspNetCore.Mvc.DataTables.Options();
        }
        ...
        public static void RegisterDataTables(this IServiceCollection services) { services.RegisterDataTables(new Ecubytes.AspNetCore.Mvc.DataTables.Options()); }
        ...
        public static void RegisterDataTables(this IServiceCollection services, ModelBinder requestModelBinder) { services.RegisterDataTables(new Ecubytes.AspNetCore.Mvc.DataTables.Options(), requestModelBinder); }
